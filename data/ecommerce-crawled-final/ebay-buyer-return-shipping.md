...
Before you can send an item back to the seller, you need to start a return
...
A label from their preferred carrier: if the seller provides you with a shipping label, they'll send it to you directly, and you can print it from the "Here's your return shipping label" email or message that you'll receive in Messages
