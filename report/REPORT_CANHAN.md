...
|---|-------|--------------------------------|-------|-----------|------------------------|
| 1 | What happens if an item does not match the listing or arrives faulty or damaged? | `ebay-buyer-money-back-guarantee#75`: Điều khoản eBay Money Back Guarantee cho phép người mua trả hàng kể cả khi seller đặt chính sách "No returns accepted". | 0.2849 | Có (Relevant) | Người mua được quyền mở yêu cầu hoàn tiền và trả hàng theo chính sách eBay Money Back Guarantee ngay cả khi người bán không nhận đổi trả. |
| 2 | How long does the seller have to respond to a buyer's return request? | `ebay-buyer-return-refund#10`: Quy định người bán có 3 ngày làm việc (3 business days) để giải quyết yêu cầu trước khi người mua nhờ eBay can thiệp. | 0.3020 | Có (Relevant) | Người bán có thời hạn tối đa 3 ngày làm việc để phản hồi và đưa ra phương án xử lý yêu cầu trả hàng. |
| 3 | How long do refunds typically take to become available? | `ebay-buyer-money-back-guarantee#76`: Thời hạn hoàn tiền thông thường là 3-5 ngày làm việc tùy phương thức thanh toán gốc. | 0.2329 | Có (Relevant) | Khoản tiền hoàn trả thường được ghi có vào tài khoản người mua trong vòng 3 đến 5 ngày làm việc. |
| 4 | What is the maximum transaction defect rate in the seller standards policy? | `ebay-seller-standards#18`: Tiêu chuẩn đánh giá người bán quy định Transaction Defect Rate không được vượt quá 2% tổng giao dịch. | 0.2560 | Có (Relevant) | Mức tỷ lệ lỗi giao dịch tối đa cho phép đối với người bán để không bị hạ chuẩn là 2% số giao dịch. |
| 5 | List the eligibility conditions for protections for Top Rated Sellers. | `ebay-seller-standards#24`: Điều kiện bảo vệ gồm danh hiệu Top Rated, địa chỉ tại Mỹ/Canada, không bị phạt dịch vụ và chính sách đổi trả tối thiểu 30 ngày. | 0.2450 | Có (Relevant) | Người bán phải đạt chuẩn Top Rated, cư trú tại US/Canada, duy trì chỉ số dịch vụ tốt, bán trên eBay.com và áp dụng đổi trả ít nhất 30 ngày. |

**Bao nhiêu câu hỏi trả về chunk có liên quan trong top-3?** 5 / 5

> *Ghi chú về Backend Embedding:* Benchmark cá nhân được chạy trên `MockEmbedder` (băm MD5 n-gram). Do tính chất băm ký tự, các điểm score phản ánh sự trùng lặp bề mặt; do đó trọng tâm đánh giá được đặt vào cấu trúc phân đoạn (đạt 243 chunks hoàn chỉnh, bảo toàn tiêu đề mục và tính toàn vẹn của điều khoản) kết hợp cơ chế tiền lọc `metadata_filter` chính xác 100%.
